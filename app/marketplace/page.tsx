...
const agentFlows: Record<string, AgentFlow> = {
  ...
  'Sprint Planning RAG': {
    ...
    glowRgba: 'rgba(76,201,240,0.15)',
    nodes: [
      { label: 'Jira/Linear History' },
      { label: 'Ticket Similarity' },
...
const products: Product[] = [
  ...
  { name: 'Incident Response Agent', type: 'Agent', category: 'sdlc', description: 'Monitors alerts (PagerDuty, CloudWatch), correlates logs, suggests root cause, drafts runbooks, and auto-remediates known patterns.', status: 'In Development', icon: '🚨' },
  ...
  { name: 'Sprint Planning RAG', type: 'RAG', category: 'sdlc', description: 'Ingests Jira/Linear history, estimates story points based on similar past tickets, flags scope creep patterns.', status: 'In Development', icon: '📋' },
  ...
  { name: 'Clinical Documentation Agent', type: 'Agent', category: 'healthcare', description: 'Listens to physician-patient conversations, generates structured SOAP notes, codes diagnoses (ICD-10), and drafts referral letters.', status: 'In Development', icon: '🏥' },
  { name: 'Medical Literature RAG', type: 'RAG', category: 'healthcare', description: 'Ingests PubMed, UpToDate, and internal protocols. Answers clinical questions with cited evidence and guideline references.', status: 'In Development', icon: '📚' },
  { name: 'Prior Authorization Agent', type: 'Agent', category: 'healthcare', description: 'Reads denial letters, matches patient records to payer criteria, drafts appeal letters with supporting evidence.', status: 'In Development', icon: '📋' },
  { name: 'Patient Intake Agent', type: 'Agent', category: 'healthcare', description: 'Conversational agent that collects symptoms, history, and medications before appointments. Structures data for the EHR.', status: 'In Development', icon: '🩺' },
  { name: 'Care Gap Identifier', type: 'RAG', category: 'healthcare', description: 'Queries patient records against preventive care guidelines (HEDIS measures) and generates outreach lists.', status: 'In Development', icon: '🔎' },
  ...
  { name: 'Contract Review RAG', type: 'RAG', category: 'cross-domain', description: 'Ingests company templates, past negotiations, and legal playbook. Redlines incoming contracts and flags non-standard terms.', status: 'In Development', icon: '📄' },
  { name: 'Onboarding Agent', type: 'Agent', category: 'cross-domain', description: 'Guides new hires through company knowledge — answers questions about processes, tools, people, and policies from internal docs.', status: 'In Development', icon: '👋' },
  { name: 'Meeting Action Agent', type: 'Agent', category: 'cross-domain', description: 'Joins calls, transcribes, extracts action items, creates tickets, and follows up on overdue items.', status: 'In Development', icon: '🎙️' },
  { name: 'Knowledge Base Curator', type: 'Agent', category: 'cross-domain', description: 'Monitors Slack/Teams for answers to repeated questions, auto-drafts FAQ articles, and keeps docs updated.', status: 'In Development', icon: '🧠' },
]
